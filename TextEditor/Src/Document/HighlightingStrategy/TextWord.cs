...
namespace ICSharpCode.TextEditor.Document
{
	...
	public class TextWord
	{
		...
		public sealed class WideSpaceTextWord : TextWord
		{
			public WideSpaceTextWord()
			{
				length = 1;
			}

			public WideSpaceTextWord(HighlightColor color)
			{
				length = 1;
				base.SyntaxColor = color;
			}
		...
		static TextWord wideSpaceWord = new WideSpaceTextWord();
		...
		public static TextWord WideSpace
		{
			get
			{
				return wideSpaceWord;
			}
		}
