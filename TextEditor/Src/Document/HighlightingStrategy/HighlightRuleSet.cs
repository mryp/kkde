...
namespace ICSharpCode.TextEditor.Document
{
	public class HighlightRuleSet
	{
		...
		List<PrevMarker> prevMarkList = new List<PrevMarker>();
		Dictionary<string, HighlightColor> keyWordsList = new Dictionary<string, HighlightColor>();
		...
		public List<PrevMarker> PrevMarkList
		{
			get
			{
				return prevMarkList;
		...
		public Dictionary<string, HighlightColor> KeyWordsList
		{
			get
			{
				return keyWordsList;
